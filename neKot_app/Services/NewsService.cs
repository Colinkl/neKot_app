    ...
    public class NewsService
    {
        ...
        public async Task<List<NewsModel>> GetNews(int pageId)
        {
            try
            {
                ...
                respStr = respStr.Replace("id", nameof(NewsModel.Id))
                                 .Replace("title", nameof(NewsModel.Title))
                                 .Replace("avatar", nameof(NewsModel.Avatar))
                                 .Replace("date", nameof(NewsModel.Date))
                                 .Replace("link", nameof(NewsModel.Link));
